...
// Importok a backend és frontend mappákból
...
export default async function RootLayout(props: {
  ...
  // Ellenőrizzük, hogy létezik-e a nyelv
  if (!hasLocale(routing.locales, locale)) {
    notFound();
  }

  // Beállítjuk a nyelvet a kéréshez
  setRequestLocale(locale);

  // Lekérjük a fordításokat a navigációhoz (RootLayout névtér)
    ...
    <html lang={locale}>
      <body>
        <NextIntlClientProvider>
                    ...
                    <span className="flex items-center gap-2">
                      ...
                      >
                        ...
                        >
                          ...
                          <path d="M 29.621 61.379 c -0.256 0 -0.512 -0.098 -0.707 -0.293 c -0.391 -0.391 -0.391 -1.023 0 -1.414 l 30.758 -30.758 c 0.391 -0.391 1.023 -0.391 1.414 0 c 0.391 0.391 0.391 1.023 0 1.414 L 30.327 61.086 C 30.132 61.281 29.876 61.379 29.621 61.379 z" />
                          ...
                          <path d="M 81.007 81.856 c -0.256 0 -0.512 -0.098 -0.707 -0.293 L 52.382 53.645 c -0.391 -0.391 -0.391 -1.023 0 -1.414 s 1.023 -0.391 1.414 0 l 27.918 27.917 c 0.391 0.391 0.391 1.023 0 1.414 C 81.519 81.758 81.263 81.856 81.007 81.856 z" />
                ...
                <li>
                  ...
                  >
                    <span className="flex items-center gap-2">
                      ...
                      >
                        <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81)">
                          <path d="M 76.595 79.557 H 5.059 c -2.79 0 -5.059 -2.27 -5.059 -5.059 v -50.65 c 0 -2.79 2.269 -5.059 5.059 -5.059 h 71.536 c 2.79 0 5.06 2.269 5.06 5.059 v 50.65 C 81.654 77.287 79.385 79.557 76.595 79.557 z M 5.059 20.79 C 3.372 20.79 2 22.162 2 23.848 v 50.65 c 0 1.687 1.372 3.059 3.059 3.059 h 71.536 c 1.688 0 3.06 -1.372 3.06 -3.059 v -50.65 c 0 -1.687 -1.372 -3.059 -3.06 -3.059 H 5.059 z" />
                          ...
                          <path d="M 31.282 44.853 c -4.017 0 -7.285 -3.268 -7.285 -7.285 s 3.268 -7.284 7.285 -7.284 s 7.285 3.268 7.285 7.284 S 35.299 44.853 31.282 44.853 z M 31.282 32.284 c -2.914 0 -5.285 2.371 -5.285 5.284 c 0 2.914 2.371 5.285 5.285 5.285 s 5.285 -2.371 5.285 -5.285 C 36.567 34.654 34.196 32.284 31.282 32.284 z" />
                          <path d="M 89 67.151 c -0.553 0 -1 -0.447 -1 -1 V 15.502 c 0 -1.687 -1.372 -3.059 -3.059 -3.059 H 13.405 c -0.552 0 -1 -0.448 -1 -1 s 0.448 -1 1 -1 h 71.537 c 2.789 0 5.059 2.27 5.059 5.059 v 50.649 C 90 66.704 89.553 67.151 89 67.151 z" />
                        </g>
                      </svg>
                      {t('gallery_link')}
                    </span>
                ...
                <li>
                  ...
                  >
                    <span className="flex items-center gap-2 whitespace-nowrap">
                      ...
                      >
                        <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81)">
                          <path d="M 51.639 71 H 45.17 c -1.104 0 -2 -0.896 -2 -2 V 42.064 h -4.809 c -1.104 0 -2 -0.896 -2 -2 s 0.896 -2 2 -2 h 6.809 c 1.105 0 2 0.896 2 2 V 67 h 4.469 c 1.104 0 2 0.896 2 2 S 52.743 71 51.639 71 z" />
                          <path d="M 45.17 28.787 c -1.104 0 -2 -0.896 -2 -2 V 21 c 0 -1.104 0.896 -2 2 -2 c 1.105 0 2 0.896 2 2 v 5.787 C 47.17 27.892 46.275 28.787 45.17 28.787 z" />
          ...
          >
            {/* Itt a tartalmi wrapper, ami a második fájlban volt */}
            <div className="py-2 text-xl [&_p]:my-6 ">
              {props.children}
            </div>
          </BaseTemplate>
        </NextIntlClientProvider>
